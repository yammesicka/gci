...
var MissingParameterClosingBracketsError = fmt.Errorf("section parameter is missing closing %q", ")")
var MoreThanOneOpeningQuotesError = fmt.Errorf("found more than one %q parameter start sequences", ")")
